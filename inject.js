$(window).on('ExtLoad', function (e) {
    addExtTab("Agent List","Agentlistextension").append( '<script src="'+$('#AgentlistextensionContentScript').data('dynatablelink')+'"></script>'+
        '<script src="'+$('#AgentlistextensionContentScript').data('filesaverlink')+'"></script>'+
        '<link rel="stylesheet" type="text/css" href="'+$('#AgentlistextensionContentScript').data('csslink')+'" media="screen" />'+
        '<div id="progress" style="padding:10px 0px 10px 0px" />'+
        '<div class="table-style-two-container">'+
        '<table id="license">'+
            '<tbody><tr/></tbody>'+
        '</table>'+
        '<table id="errors" class="table-style-two" style="display:none">'+
            '<thead>'+
                '<th>Type</th>'+
                '<th>Application</th>'+
                '<th>Tier</th>'+
            ...
            '<tbody>'+
            '</tbody>'+
        '</table><div id=download>Download</div>'+
        '</div>')
    if(count==0) go()
    else draw()
});
